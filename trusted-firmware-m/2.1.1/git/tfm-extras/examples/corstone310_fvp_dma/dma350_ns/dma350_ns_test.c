...
static struct dma350_ch_dev_t DMA350_DMA0_CH1_DEV_NS = {
    .cfg = {.ch_base = (DMACH_TypeDef *)(DMA_350_BASE_NS + 0x1100UL),
            .channel = 1},
    .data = {0}};

static struct test_t plat_ns_t[] = {
    {&dma350_native_drv_test, "TFM_NS_EXTRA_TEST_1001",
     "DMA350 Native driver"},
    {&dma350_library_test, "TFM_NS_EXTRA_TEST_1002",
     "DMA350 Library"},
};
...
void register_testsuite_extra_ns_interface(struct test_suite_t *p_test_suite)
{
    ...
    set_testsuite("Extra Nonsecure interface tests"
...
static void dma350_native_drv_test(struct test_result_t *ret)
{
    ...
    /* Init DMA channel */
    ch_err = dma350_ch_init(&DMA350_DMA0_CH1_DEV_NS);
